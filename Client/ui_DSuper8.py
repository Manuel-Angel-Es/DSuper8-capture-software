# Form implementation generated from reading ui file 'DSuper8.ui'
#
...
"loaded in the user interface.")
        ...
        self.loadConfigButton.setStyleSheet("")
...
"Framerate parameter in frames per second.")
        ...
        self.gainsGroupBox = QtWidgets.QGroupBox(parent=self.tab_cap)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.gainsGroupBox.sizePolicy().hasHeightForWidth())
        self.gainsGroupBox.setSizePolicy(sizePolicy)
        self.gainsGroupBox.setMinimumSize(QtCore.QSize(150, 55))
        self.gainsGroupBox.setMaximumSize(QtCore.QSize(150, 55))
        self.gainsGroupBox.setToolTip("")
        self.gainsGroupBox.setTitle("Gains")
        self.gainsGroupBox.setAlignment(QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignTop)
        self.gainsGroupBox.setObjectName("gainsGroupBox")
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout(self.gainsGroupBox)
        self.horizontalLayout_7.setContentsMargins(-1, -1, -1, 9)
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.gainLabelA = QtWidgets.QLabel(parent=self.gainsGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.gainLabelA.sizePolicy().hasHeightForWidth())
        self.gainLabelA.setSizePolicy(sizePolicy)
        self.gainLabelA.setMinimumSize(QtCore.QSize(12, 25))
        self.gainLabelA.setMaximumSize(QtCore.QSize(12, 25))
        self.gainLabelA.setToolTip("Analog gain reported by the camera.\n"
"Values between 1 and 16.")
        ...
        self.gainBoxA = QtWidgets.QDoubleSpinBox(parent=self.gainsGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"Values between 1 and 16.")
        ...
        self.gainLabelD = QtWidgets.QLabel(parent=self.gainsGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.gainLabelD.sizePolicy().hasHeightForWidth())
        self.gainLabelD.setSizePolicy(sizePolicy)
        self.gainLabelD.setMinimumSize(QtCore.QSize(12, 25))
        self.gainLabelD.setMaximumSize(QtCore.QSize(12, 25))
        self.gainLabelD.setToolTip("Digital gain reported by camera.\n"
"If it is not close to 1, the lighting is too low.")
        self.gainLabelD.setText("D")
        self.gainLabelD.setObjectName("gainLabelD")
        self.horizontalLayout_7.addWidget(self.gainLabelD)
        self.gainBoxD = QtWidgets.QDoubleSpinBox(parent=self.gainsGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"If it is not close to 1, the lighting is too low.")
        ...
        self.verticalLayout_27.addWidget(self.gainsGroupBox)
...
"- Motion of the film.")
        ...
        self.jpgCheckBox = QtWidgets.QCheckBox(parent=self.tab_adv)
        self.jpgCheckBox.setMinimumSize(QtCore.QSize(50, 30))
        self.jpgCheckBox.setMaximumSize(QtCore.QSize(50, 30))
        self.jpgCheckBox.setToolTip("Activate jpg format in the output file.")
        self.jpgCheckBox.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.jpgCheckBox.setText("jpg")
        self.jpgCheckBox.setChecked(True)
        self.jpgCheckBox.setObjectName("jpgCheckBox")
        self.horizontalLayout_32.addWidget(self.jpgCheckBox)
        ...
        self.rawCheckBox = QtWidgets.QCheckBox(parent=self.tab_adv)
        self.rawCheckBox.setMinimumSize(QtCore.QSize(50, 30))
        self.rawCheckBox.setMaximumSize(QtCore.QSize(50, 30))
        self.rawCheckBox.setToolTip("Activate raw-dng format in the output file.")
        self.rawCheckBox.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.rawCheckBox.setObjectName("rawCheckBox")
        self.horizontalLayout_32.addWidget(self.rawCheckBox)
...
"Camera default: Centre weighted.")
        ...
        spacerItem35 = QtWidgets.QSpacerItem(15, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
...
"of the current frame.")
        ...
        self.horizontalLayout_38.addItem(spacerItem36)
...
"Adjust focus to the maximum possible value.")
        ...
        spacerItem40 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_41.addItem(spacerItem40)
        self.verticalLayout_16.addLayout(self.horizontalLayout_41)
        spacerItem41 = QtWidgets.QSpacerItem(20, 5, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.verticalLayout_16.addItem(spacerItem41)
        self.horizontalLayout_46 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_46.setObjectName("horizontalLayout_46")
        spacerItem42 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        self.gridLayout.addItem(spacerItem43, 2, 2, 1, 1)
        spacerItem44 = QtWidgets.QSpacerItem(100, 30, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout.addItem(spacerItem44, 0, 2, 1, 1)
        spacerItem45 = QtWidgets.QSpacerItem(100, 30, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout.addItem(spacerItem45, 1, 1, 1, 1)
...
"be removed from the image.")
        ...
        self.cropRightLabel.setToolTip("Width in pixels of the right strip to\n"
"be removed from the image.")
        ...
        self.cropRightBox.setToolTip("Width in pixels of the right strip to\n"
"be removed from the image.")
...
"remove unwanted edges.")
        ...
        spacerItem46 = QtWidgets.QSpacerItem(100, 30, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout.addItem(spacerItem46, 2, 0, 1, 1)
        self.horizontalLayout_46.addLayout(self.gridLayout)
        spacerItem47 = QtWidgets.QSpacerItem(10, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_46.addItem(spacerItem47)
        self.verticalLayout_16.addLayout(self.horizontalLayout_46)
        spacerItem48 = QtWidgets.QSpacerItem(20, 5, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
...
"of the image.")
        ...
        spacerItem50 = QtWidgets.QSpacerItem(127, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        spacerItem51 = QtWidgets.QSpacerItem(5, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
...
"of the image.")
        ...
        self.ReinhardIntensityLabel.setMinimumSize(QtCore.QSize(54, 25))
        self.ReinhardIntensityLabel.setMaximumSize(QtCore.QSize(54, 25))
...
"combination of the two.")
        ...
        self.ReinhardColorLabel.setMinimumSize(QtCore.QSize(54, 25))
        self.ReinhardColorLabel.setMaximumSize(QtCore.QSize(54, 25))
...
"By default 0.85.")
        ...
        spacerItem54 = QtWidgets.QSpacerItem(5, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_63.addItem(spacerItem54)
...
"the best results.")
        ...
        spacerItem56 = QtWidgets.QSpacerItem(20, 19, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
...
"be as close to 1 as possible.")
        ...
        spacerItem57 = QtWidgets.QSpacerItem(13, 30, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
...
"Default value 0.0.")
        ...
        spacerItem58 = QtWidgets.QSpacerItem(0, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
...
"saturation to 1.00.")
        ...
        spacerItem59 = QtWidgets.QSpacerItem(14, 30, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        self.jpgCheckBox.toggled['bool'].connect(DSuper8.setJpg) # type: ignore
        self.rawCheckBox.toggled['bool'].connect(DSuper8.setRaw) # type: ignore
        self.prevCheckBox.toggled['bool'].connect(DSuper8.previewSet) # type: ignore
    ...
    def retranslateUi(self, DSuper8):
        ...
        self.rawCheckBox.setText(_translate("DSuper8", "raw"))
